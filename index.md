...
In this figure are counted each person that is significantly involved in the US media, with between 25 and 10'000 comments per year on the channels classified by [AllSides](www.allsides.com). Allsides is a website that categorizes media according to their political bias. They use different methods to class the a media in the five following categories : "Left, Lean Left, Center , Lean Right, Right". Unfortunately, distributions before 2015 were ignored due to a lack of data. This is due to the rapid growth of YouTube in the last years, as seen previously.
